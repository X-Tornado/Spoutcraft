...
public class RenderGlobal implements IWorldAccess {
	...
	public void renderSky(float par1) {
		...
		if (this.mc.theWorld.provider.dimensionId == 1) {
			...
			var12 = 30.0F;
			GL11.glBindTexture(GL11.GL_TEXTURE_2D, this.renderEngine.getTexture(SkyRenderer.setupCelestialObject("/terrain/sun.png")));
			...
			var23.draw();
			var12 = 20.0F;
			GL11.glBindTexture(GL11.GL_TEXTURE_2D, this.renderEngine.getTexture(SkyRenderer.setupCelestialObject("/terrain/moon_phases.png")));
