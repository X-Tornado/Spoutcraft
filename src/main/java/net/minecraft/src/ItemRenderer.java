...
public class ItemRenderer {
	...
	public void renderItem(EntityLiving par1EntityLiving, ItemStack par2ItemStack, int par3) {
		...
		if (var4 != null && RenderBlocks.renderItemIn3d(var4.getRenderType())) {
			...
			float var7 = ((float)(var6 % 16 * TileSize.int_size) + 0.0F) / TileSize.float_size16;
			float var8 = ((float)(var6 % 16 * TileSize.int_size) + TileSize.float_sizeMinus0_01) / TileSize.float_size16;
			float var9 = ((float)(var6 / 16 * TileSize.int_size) + 0.0F) / TileSize.float_size16;
			float var10 = ((float)(var6 / 16 * TileSize.int_size) + TileSize.float_sizeMinus0_01) / TileSize.float_size16;
			float var11 = 0.0F;
			float var12 = 0.3F;
